...
export function ResumeModal({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-2 sm:p-4 z-50">
      <Card className="bg-white dark:bg-gray-900 max-w-6xl w-full max-h-[95vh] sm:max-h-[90vh] overflow-hidden">
        <CardHeader className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0 pb-4 border-b gap-2">
          ...
          <div className="flex items-center gap-2">
            <Button
              ...
              className="text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 text-xs sm:text-sm"
            >
              {copied ? (
                <>
